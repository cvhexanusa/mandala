    ...
    <div className="relative">
      ...
      >
        ...
        <button
          ...
          className="flex items-center w-full gap-3 px-3 py-2 mt-2 font-medium text-error-600 rounded-lg group text-theme-sm hover:bg-error-50 dark:text-error-400 dark:hover:bg-error-500/10"
        >
          <svg
            width="20"
            height="20"
