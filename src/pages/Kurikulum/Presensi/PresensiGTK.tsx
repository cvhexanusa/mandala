...
const PresensiGTK: React.FC = () => {
  ...
  const fetchAttendance = useCallback(async () => {
    ...
    try {
      ...
      setAllPdRecords(pdList);

      // Format individual log data for GTK
  ...
  return (
    <>
      <PageMeta
        title="Laporan Presensi GTK | SIMAK"
        description="Analisis status presensi GTK harian."
      />
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6 mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Audit kehadiran harian Guru dan Tenaga Kependidikan per instansi sekolah.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12">
              <ComponentCard title="Kepatuhan Presensi GTK Satuan Pendidikan">
